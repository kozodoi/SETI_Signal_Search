...
def get_train_file_path(image_id, CFG):
    return CFG['data_path'] + 'train/{}/{}.npy'.format(image_id[0], image_id)
def get_test_file_path(image_id, CFG):
    return CFG['data_path'] + 'test/{}/{}.npy'.format(image_id[0], image_id)
def get_train_old_file_path(image_id, CFG):
    return CFG['data_path'] + 'train_old/{}/{}.npy'.format(image_id[0], image_id)
def get_test_old_file_path(image_id, CFG):
    return CFG['data_path'] + 'test_old/{}/{}.npy'.format(image_id[0], image_id)
def get_off_file_path(image_id, CFG):
    return CFG['data_path'] + 'train_off/{}/{}.npy'.format(image_id[0], image_id)
def get_train_old_off_file_path(image_id, CFG):
    return CFG['data_path'] + 'train_old_off/{}/{}.npy'.format(image_id[0], image_id)
